...
export default function Wiki({ pokemon: initialData }: Props) {
	...
	return (
		<div className='h-screen p-6 pt-20 flex flex-col gap-4 overflow-hidden'>
			...
			<div className='flex w-full h-full overflow-hidden'>
				<div className='w-[25%] min-w-fit mr-6 overflow-y-auto h-full'>
				...
				<div className='flex flex-col w-full gap-4 h-full'>
						...
						<>
							...
							<div className='flex w-full overflow-y-auto'>
								<div className='w-full flex flex-col overflow-y-auto'>
									<div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 flex-1 [grid-auto-rows:150px] overflow-y-auto p-2'>
										{pokemon.map((p, idx) => {
											...
											return (
												<article
													key={key}
													className='ring-indigo-200 bg-indigo-300/5 ring-1 rounded-2 col-span-1 p-8 shadow-md flex flex-col justify-center'
												>
                    ...
                    <p className="text-sm">Nickname: “{p.nickname}”</p>
										...
										{pokemon.length === 0 && (
											<p className='mt-4 -ml-2'>No matches.</p>
										)}
									</div>
								</div>
							</div>
